...
<template>
  <v-footer absolute app class="d-flex align-center bg-black text-primary text-body-2 px-12">
    <v-container>
      <v-row class="bg-black">
        <v-col cols="12" md="2" class="d-flex align-center justify-center justify-md-start py-0">
          <p class="pt-2 pt-md-0" :style="{ fontSize: '12px' }">
            Benthos © {{ new Date().getFullYear() }}
          </p>
        </v-col>

        <v-col cols="12" md="8" class="d-flex align-center justify-center py-0">
          <SocialMediaButtons :color="'text-primary'" />
        </v-col>

        <v-col cols="12" md="2" class="d-flex align-center justify-center justify-md-end py-0 pl-0">
